...
function sendTransformedIndex (req, res, next) {
  ...
  if (req.pkg) {
    if (req.pkg.vigour) {
      if (req.pkg.vigour.languages) {
        console.log('languages', req.pkg.vigour.languages)
      } else {
        console.log('no req.pkg.vigour.languages')
      }
    } else {
      console.log('no req.pkg.vigour')
    }
  } else {
    console.log('no req.pkg')
  }
